...
def test_sol_time_efolds(K):
    ...
    assert_allclose(bist.P_t_approx_CGS1(k) * 1e9, bist.P_t_approx_CGS3(k) * 1e9, rtol=1e-2)
    assert_allclose(bist.P_s_approx_CGS2(k) * 1e9, bist.P_s_approx_CGS3(k) * 1e9, rtol=1e-2)
    assert_allclose(bist.P_t_approx_CGS2(k) * 1e9, bist.P_t_approx_CGS3(k) * 1e9, rtol=1e-2)
